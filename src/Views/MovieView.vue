<template>
    <div v-if="loaded" class="movie-container">
      ...
      <div class="movie-content">
        <div class="movie-box">
          ...
          <!-- Left column: Trailer image (desktop only) -->
          <img
            class="trailer-image"
            :src="movie!.trailerImageUrl"
            alt="Trailer"
            @click="handleTrailerClick"
          />
  
          <!-- Right column: All content -->
          <div class="movie-details">
            <!-- Title + meta + genres + mobile image -->
            <div class="title-row">
  ...
  <div class="popup-image-wrapper">
    ...
    <img
      class="popup-trailer-image"
      :src="movie!.trailerImageUrl"
      alt="Trailer Large View"
    />
  </div>
</div>
